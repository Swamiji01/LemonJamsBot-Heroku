# PikachumusicBot - Heroku
## My fork of [𝙿𝙸𝙺𝙰𝙲𝙷𝚄](https://github.com/Swamiji01/LemonJamsBot) repository 
...
### Webserver setup
* deploy [𝙿𝙸𝙺𝙰𝙲𝙷𝚄](https://github.com/Swamiji01/LemonJamServer) repo in heroku (you can use ```deploy to heroku``` button for easy peasy deployment)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Swamiji01/LemonJamsBot-Heroku/tree/main)
